...
const handleUserCreated = (deps: Dependencies) => async (payload: any): Promise<void> => {
...
const handleSchoolCreated = (deps: Dependencies) => async (payload: any): Promise<void> => {
...
const handleStaffAssigned = (deps: Dependencies) => async (payload: any): Promise<void> => {
...
const handleProfileUpdated = (deps: Dependencies) => async (payload: any): Promise<void> => {
...
const handleSchoolUpdated = (deps: Dependencies) => async (payload: any): Promise<void> => {
  if (payload.criticalFieldsChanged) {
    await deps.prisma.verificationHistory.create({
      data: {
        entityId: payload.schoolId,
...
const handleFileUploaded = (deps: Dependencies) => async (payload: any): Promise<void> => {
...
export const submitDocument = (deps: Dependencies) => (
  userId: string,
  type: DocumentType,
  documentUrls: string[],
...
export const verifyDocument = (deps: Dependencies) => (
  documentId: string,
...
export const getDocumentsByUser = (deps: Dependencies) => (
  userId: string
): TE.TaskEither<KYCError, any[]> =>
  pipe(
    TE.tryCatch(
...
export const getVerificationHistory = (deps: Dependencies) => (
  entityId: string
): TE.TaskEither<KYCError, any[]> =>
  pipe(
    TE.tryCatch(
